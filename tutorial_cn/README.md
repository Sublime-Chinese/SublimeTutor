Sublimez中文辅导
===========
> 这是一个`Sublime Text 3`中一个交互式的快捷键辅导教程.

目录
-------
- chapter1 Goto Anything(跳转)
- chapter2 Editing text(编辑)
- chapter3 Selection(选择)
- chapter4 Navigation(引导)
- chapter5 Find / Replace(查找 / 替换)
- chapter6 Other commands(其他命令)
